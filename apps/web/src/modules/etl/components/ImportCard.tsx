import { Upload, FileJson, Map, Plug, Database, Clock, CheckCircle, XCircle, Loader2 } from 'lucide-react'
  ...
  return (
    <button
      ...
      className={`
        ...
        ${disabled ? 'opacity-50 cursor-not-allowed bg-gray-50' : 'hover:border-primary hover:shadow-md cursor-pointer bg-white'}
        dark:bg-gray-800 dark:border-gray-700 dark:hover:border-primary
      `}
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">{subtitle}</p>
        </div>
        {StatusIcon && (
          <StatusIcon
            size={20}
