...
import { AuthProvider } from '@techdados/shared'
...
const ModulesConfigPage = lazy(() =>
  import('@/pages/admin/config/ModulesConfigPage').then(m => ({ default: m.ModulesConfigPage }))
)
const FiltersConfigPage = lazy(() =>
  import('@/pages/admin/config/FiltersConfigPage').then(m => ({ default: m.FiltersConfigPage }))
)
