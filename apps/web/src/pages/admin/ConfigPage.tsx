...
import { Button, Card } from '@techdados/design-system'
        ...
        {[
          {
            ...
            desc: 'Receber alertas importantes por email',
          },
      ...
      <div className="space-y-4">
        {[
          ...
          { id: 'api', name: 'API Backend', status: 'connected', desc: 'REST API principal' },
          {
            ...
            status: 'disconnected',
            desc: 'Armazenamento de arquivos',
          },
          {
            id: 'email',
            name: 'Servidor de Email',
            status: 'disconnected',
            desc: 'SMTP para notificações',
          },
        ].map(item => (
          <div
            key={item.id}
          ...
          >
            <div className="flex items-center gap-4">
              <div
                className={`w-3 h-3 rounded-full ${item.status === 'connected' ? 'bg-green-500' : 'bg-gray-400'}`}
              />
              <div>
