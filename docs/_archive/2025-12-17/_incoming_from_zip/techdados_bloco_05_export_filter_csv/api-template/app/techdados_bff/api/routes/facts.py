...
from app.techdados_bff.infra.export_filters import filter_csv_by_municipio_scope
...
async def facts(
    ...
    if format == "parquet":
        # MVP: parquet por escopo municipal permanece bloqueado (policy/export doc)
